...
class FhirstarterStack(core.Stack):
    def __init__(
        self,
        ...
        **kwargs,
        ...
        """
        A stack that spins up a Fargate cluster running FHIRStarter (HAPI with NAGIM auth) with an ALB in-front.
        ...
        asset = ecrassets.DockerImageAsset(self, "FhirstarterImage",
            directory="server"
        )
